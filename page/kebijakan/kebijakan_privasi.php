...
<section class="privacy section-padding">
    <div class="container">
        ...
        <div class="privacy-text text-justify text-md-start">
            ...
            <p>
                Istilah yang digunakan dalam Kebijakan Privasi ini memiliki arti yang sama seperti dalam Syarat dan Ketentuan kami, yang dapat diakses di Roda Indonesia kecuali ditentukan lain dalam Kebijakan Privasi ini.
            </p>
            <h5>Pengumpulan dan Penggunaan Informasi</h5>
            <p>
                Untuk pengalaman yang lebih baik, saat menggunakan Layanan kami, kami mungkin meminta Anda untuk memberi kami informasi identitas pribadi tertentu. Informasi yang kami minta akan disimpan oleh kami dan digunakan seperti yang dijelaskan dalam kebijakan privasi ini.
            </p>
            <div>
                <p>
                ...
                <ul>
                    <li> <a href="https://www.google.com/policies/privacy/" target="_blank" rel="noopener noreferrer"> Layanan Google Play </a> </li>
                    <li> <a href="https://support.google.com/admob/answer/6128543?hl=id" target="_blank" rel="noopener noreferrer"> AdMob </a> </li>
            ...
            <p>
                Kami ingin memberi tahu pengguna Layanan ini bahwa pihak ketiga ini memiliki akses ke Informasi Pribadi Anda. Alasannya adalah untuk melakukan tugas yang diberikan kepada mereka atas nama kami. Namun, mereka berkewajiban untuk tidak mengungkapkan atau menggunakan informasi tersebut untuk tujuan lain apa pun.
            </p>
            <p>
                <ul>
                    <li>Security</i>
            ...
            <h5> Tautan ke Situs Lain </h5>
            <p>
                Layanan ini mungkin berisi tautan ke situs lain. Jika Anda mengeklik tautan pihak ketiga, Anda akan diarahkan ke situs itu. Catatan bahwa situs eksternal ini tidak dioperasikan oleh kami. Oleh karena itu, kami sangat menyarankan Anda untuk meninjau Kebijakan Privasi situs web ini. Kami tidak memiliki kendali atas dan tidak bertanggung jawab atas konten, kebijakan privasi, atau praktik situs atau layanan pihak ketiga mana pun.
            </p>
            <h5> Privasi Anak-Anak </h5>
            <p>
                Layanan ini tidak ditujukan kepada siapa pun yang berusia di bawah 17 tahun. Kami tidak dengan sengaja mengumpulkan informasi yang dapat diidentifikasi secara pribadi dari anak-anak di bawah 17. Dalam kasus kami menemukan bahwa seorang anak di bawah 17 tahun telah memberi kami informasi pribadi, kami segera menghapusnya dari server kami. Jika Anda adalah orang tua atau wali dan Anda mengetahui bahwa anak Anda telah memberi kami informasi pribadi, silakan hubungi kami sehingga kami dapat melakukan tindakan yang diperlukan.
            </p>
            <h5> Perubahan pada Kebijakan Privasi Ini </h5>
            <p>
            ...
            <p> Kebijakan ini berlaku mulai 2021-02-07 </p>
            <h5> Hubungi Kami </h5>
            <p>
                Jika Anda memiliki pertanyaan atau saran tentang Kebijakan Privasi kami, jangan ragu untuk menghubungi kami di rodaindonesia.1@gmail.com.
            </p>
        </div>
    </div>
</section>